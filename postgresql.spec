...
Patch7: postgresql-CVE-2015-0241.patch
Patch8: postgresql-CVE-2015-0241-2.patch
Patch9: postgresql-CVE-2015-0243.patch
Patch10: postgresql-CVE-2015-0244.patch
Patch11: postgresql-CVE-2014-8161.patch
Patch12: postgresql-CVE-2015-3165.patch
Patch13: postgresql-CVE-2015-3166.patch
Patch14: postgresql-CVE-2015-3167.patch
...
* Wed Oct 21 2015 Pavel Raiskup <praiskup@redhat.com> - 8.4.20-4
- fix for CVE-2015-5288 (rhbz#1273446)

* Wed May 27 2015 Pavel Raiskup <praiskup@redhat.com> - 8.4.20-3
- CVE-2015-3165, CVE-2015-3166, CVE-2015-3167

* Tue Mar 10 2015 Pavel Raiskup <praiskup@redhat.com> - 8.4.20-2
- fix for CVE-2015-0241 CVE-2015-0243 CVE-2015-0244 CVE-2014-8161
  (rhbz#1198651 & rhbz#1198652)

* Tue Feb 18 2014 Pavel Raiskup <praiskup@redhat.com> - 8.4.20-1
...
* Fri Oct 11 2013 Pavel Raiskup <praiskup@redhat.com> - 8.4.18-1
...
* Mon Aug 27 2012 Tom Lane <tgl@redhat.com> 8.4.13-1
...
* Wed Jun 13 2012 Tom Lane <tgl@redhat.com> 8.4.12-1
...
* Tue Jun 12 2012 Tom Lane <tgl@redhat.com> 8.4.11-2
- Add patches for CVE-2012-2143, CVE-2012-2655
Resolves: #830726

* Thu Apr 12 2012 Tom Lane <tgl@redhat.com> 8.4.11-1
...
* Tue Sep 27 2011 Tom Lane <tgl@redhat.com> 8.4.9-1
...
* Fri Jan 28 2011 Tom Lane <tgl@redhat.com> 8.4.7-1
...
* Thu Nov 11 2010 Tom Lane <tgl@redhat.com> 8.4.5-2
- Ensure we don't package any .gitignore files from the source tarball
Resolves: #650913

* Mon Oct  4 2010 Tom Lane <tgl@redhat.com> 8.4.5-1
